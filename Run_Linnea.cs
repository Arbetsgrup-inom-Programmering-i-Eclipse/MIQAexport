    ...
    public class Run
    {
        ...
        public void Execute()
        {
            ...
            try //Testa att köra scriptet, om krasch gå till catch
            {
                ...
                //var patientIDList = AriaInterface.GetPatientIDList(yesterday.ToString()); //Skapar listan över färdigbehandlade patienter
                DataTable patientIDList = AriaInterface.GetPatientIDList(start, end);
                ...
                foreach (DataRow patient in patientIDList.Rows) //Loopar genom varje patient från listan av patienter
                {
                    ...
                    //    RTPlansUIDs = AriaInterface.GetRTPlanUID(courseSer); //Hämtar RTPlan UIDS och Serienummer
                    ...
                    //        RTRecordsUIDS = AriaInterface.GetRTRecordUIDs(patSer, RTPlanSer); //Hämtar RTRecord UIDS
                    ...
                    RTPlansUIDs = AriaInterface.GetRTPlanUID(patientID, start, end); //Hämtar RTPlan UIDS
                    ...
                    foreach (string plan in RTPlanSeriesUIDs) //Loopar genom alla behandlade planer för patient
                    {
                        ...
                        RTRecordsUIDS = AriaInterface.GetRTRecordUIDs(plan); //Hämtar RTRecord UIDs
                        //CTUID = AriaInterface.GetCTUIDs(RTPlanSer); //Hämtar CT UIDs
                        RTStructureSetUIDs = AriaInterface.GetRTStructureSetUIDs(plan); //Hämtar RTStructureSet UIDs
                        //RTDosesUIDs = AriaInterface.GetRTDose(RTPlanSer); //Hämtar RTDose UIDs
